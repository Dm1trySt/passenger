# Ассоциативный массив в который внесены данные о 3-х пассажирах
passengers = [
    {
...
# number - номер места (+1 - сдвиг при полном прохождении на 1)
passengers.each_with_index do |passenger, number|
  ...
  puts "Пассажир: #{passenger[:first_name]}"\
        # [0] выведет первый символ хранящийся в second_name
       " #{passenger[:second_name][0]}."\
       " #{passenger[:last_name]}"
